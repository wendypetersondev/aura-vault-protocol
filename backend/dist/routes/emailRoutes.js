...
import { parseUnsubscribeToken, recordUnsubscribe, recordBounce, recordTracking, getTrackingEvents, TRACKING_GIF, verifyDnsConfiguration, } from '../services/emailService.js';
 ...
 */
emailRouter.post('/send', authenticate, userRateLimiter(), async (req, res) => {
 ...
 */
emailRouter.post('/send/bulk', authenticate, userRateLimiter(), async (req, res) => {
    const { jobs } = req.body;
...
emailRouter.get('/unsubscribe', async (req, res) => {
    ...
    res.status(200).send('<!DOCTYPE html><html><head><meta charset="utf-8"><title>Unsubscribed</title></head>' +
 ...
 */
emailRouter.post('/webhooks/sendgrid', async (req, res) => {
 ...
 */
emailRouter.post('/webhooks/mailgun', async (req, res) => {
 ...
 */
emailRouter.get('/track/click/:trackingId', async (req, res) => {
    const trackingId = String(req.params['trackingId']);
 ...
 */
emailRouter.get('/stats', authenticate, async (_req, res) => {
 ...
 */
emailRouter.get('/track/:trackingId/events', authenticate, async (req, res) => {
 ...
 */
emailRouter.get('/dns', authenticate, async (req, res) => {
